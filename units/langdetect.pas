...
begin
  ...
  begin
    // Malay uses 'msia', 'kementerian' etc, but short texts don't guarantee
    // Use presence of 'saya' (ID) vs 'saye' (MS) – not reliable.
    // Better to keep as is; 8/10 is already good.
  end;
...
begin
  ...
  // Merge into global Profiles (unchanged)
